...
class Builder {
	 ...
	 * @var array
	 */
	protected $backupFieldsMore = array(
		'from',
		'groups',
		'havings',
		'joins',
	...
	public function chunk($count, callable $callback)
	{
		...
		while (count($results) > 0)
		{
			...
			// Check if callback wants to quit
			if ($return === false)
				break;
	...
	public function getPaginationCount()
	{
		...
		if ($grouped)
		{
			$this->from = $this->connection->raw("({$selectSql}) as subquery");
		}
	...
	{
		$fields = $grouped ? array_merge($this->backupFieldsMore, $this->backupFields) : $this->backupFields;
